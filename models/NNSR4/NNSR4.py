...
N_LAYERS_NO_OPT = 5
N_UNITS_NO_OPT = [617, 858, 720, 989, 613]
HIDDEN_ACTIVATION_NAME_NO_OPT = "ReLU"
OUTPUT_ACTIVATION_NAME_NO_OPT = "ReLU"
LOSS_NAME_NO_OPT = "MSE"
OPTIMIZER_NAME_NO_OPT = "Adagrad"
LR_NO_OPT = 0.0016884179922857007
BATCH_SIZE_NO_OPT = 16
N_EPOCHS_NO_OPT = 400
SCHEDULER_NAME_NO_OPT = "CosineAnnealingLR"
...
def save_file(file_name):
  if drive_mounted:
    ...
    drive_folder = "/content/drive/My Drive/bsc/con2prim_restoration/00199" # change this to your desired folder
...
plt.xlabel("Epoch")
plt.ylabel("L1 Norm")
plt.title("NNSR4 Train and Test L1 Norm per Epoch")
plt.yscale("log")
plt.grid(True)
plt.xlim(right=200)
plt.ylim(1e-3, 1e2)
plt.legend()
plt.tight_layout()
plt.savefig("NNSR4_L1_norm_plot.png", dpi=300)
...
plt.xlabel("Epoch")
plt.ylabel("Linf Norm")
plt.title("NNSR4 Train and Test Linf Norm per Epoch")
plt.yscale("log")
plt.grid(True)
plt.xlim(right=200)
plt.ylim(1e-3, 1e2)
plt.legend()
plt.tight_layout()
plt.savefig("NNSR4_Linf_norm_plot.png", dpi=300)
...
plt.xlabel("Epoch")
plt.ylabel("MSE")
plt.title("NNSR4 MSE of Training and Test Data per Epoch")
plt.yscale("log")
plt.grid(True)
plt.xlim(right=200)
plt.ylim(1e-7, 1e0)
plt.legend()
plt.tight_layout()
plt.savefig("NNSR4_MSE_plot.png", dpi=300)
...
save_metrics_to_csv(train_metrics_loaded, 'train_metrics_NNSR4.csv')
save_metrics_to_csv(test_metrics_loaded, 'test_metrics_NNSR4.csv')
