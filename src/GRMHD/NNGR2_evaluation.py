...
N_LAYERS_NO_OPT = 5
N_UNITS_NO_OPT = [900, 113, 1440, 478, 3328]
HIDDEN_ACTIVATION_NAME_NO_OPT = "PReLU"
OUTPUT_ACTIVATION_NAME_NO_OPT = "Linear"
LOSS_NAME_NO_OPT = "MSE"
OPTIMIZER_NAME_NO_OPT = "Adagrad"
LR_NO_OPT = 0.00011087958821070323
BATCH_SIZE_NO_OPT = 512
N_EPOCHS_NO_OPT = 500 # NOTE: Set this before properly
SCHEDULER_NAME_NO_OPT = "ReduceLROnPlateau"
DROPOUT_RATE_NO_OPT = 0.4666513907706338
...
#        elif scheduler_name == "ReduceLROnPlateau":
#            scheduler = optim.lr_scheduler.ReduceLROnPlateau(
#                        optimizer, mode="min", factor=0.1268014778250041, patience=5, threshold=0.006885285639740321 #, min_lr=1e-6
#                    )
#        elif scheduler_name == "CyclicLR":
...
# And input_data is your test data for the model
...
def count_parameters(model):
        return sum(p.numel() for p in model.parameters() if p.requires_grad)
print(f'The model has {count_parameters(net_loaded)} trainable parameters.')
